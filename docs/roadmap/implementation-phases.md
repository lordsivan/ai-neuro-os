...
>
> **The implementation has its own repo:** **`ai-neuro-ba-app`**, under the GitHub org
> **`ai-neuro-stack`** (the design source of truth is the **`ai-neuro-os`** repo in the same
> org). The app repo **pins a versioned contract** published from the design repo and proves
> conformance in CI — see ADR-0003 (the seam) and ADR-0004 (the lifecycle layering / repo
> mapping). The notes below describe *what* Phase 1 builds; *how* it must conform lives in
> those ADRs.
